# P5.JS • First Steps
<a id="markdown-p5.js-%E2%80%A2-first-steps" name="p5.js-%E2%80%A2-first-steps"></a>
...
- [Downloading your work](#downloading-your-work)
- [Exercise](#exercise)
- [p5.js web editor keyboard shortcuts](#p5js-web-editor-keyboard-shortcuts)
...
☝︎ [home](../)
☞ next chapter: [Movement, Expressions & Variables](../02/movement-expressions-variables.md)

## the p5.js web editor
<a id="markdown-the-p5.js-web-editor" name="the-p5.js-web-editor"></a>
...
## Your first sketch
<a id="markdown-your-first-sketch" name="your-first-sketch"></a>
...
```
## Coordinates
<a id="markdown-coordinates" name="coordinates"></a>
...
## Change canvas size
<a id="markdown-change-canvas-size" name="change-canvas-size"></a>
...
## Fill and stroke
<a id="markdown-fill-and-stroke" name="fill-and-stroke"></a>
...
## Other Shapes
<a id="markdown-other-shapes" name="other-shapes"></a>
...
<a id="markdown-when-something-goes-wrong" name="when-something-goes-wrong"></a>
...
## Sharing your work
<a id="markdown-sharing-your-work" name="sharing-your-work"></a>
...
<a id="markdown-downloading-your-work" name="downloading-your-work"></a>
...
## Exercise
<a id="markdown-exercise" name="exercise"></a>
...
<a id="markdown-p5.js-web-editor-keyboard-shortcuts" name="p5.js-web-editor-keyboard-shortcuts"></a>
⌘ = OS X      
...
<a id="markdown-move-to-a-desktop-code-editor" name="move-to-a-desktop-code-editor"></a>
...
<a id="markdown-finding-the-browser-console" name="finding-the-browser-console"></a>
